...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Mozio",
            url: "https://github.com/mozioinc/mobile-sdk-ios/releases/download/0.1.1/Mozio.xcframework.zip", 
            checksum: "8e3dcd229c150af47b8e1199f6ccb7a299c5d44184f616449093869d72c616df"
        )
    ]
)
